...
let filename = 'https://s3.amazonaws.com/musicappsongs512/Solo+-+Clean+Bandit%2C+Demi+Lovato+-+B%C3%A0i+h%C3%A1t%2C+lyrics.MP3';
...
class AudioStreamer extends React.Component {
  ...
  _playPause() {
    console.log('AudioStreamerFragement _playPause',this.player)
